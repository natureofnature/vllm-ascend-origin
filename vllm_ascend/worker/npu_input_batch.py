...
class CachedRequestState:
    ...
    num_computed_tokens_of_cp_sp_current: Optional[list[list[int]]] = None  # 只记录当前chunk，该rank自己的token数
...
class InputBatch:
    ...
    def __init__(
        ...
        self.num_computed_tokens_of_cp_sp_current: list[list[list[int]]] = [None] * max_num_reqs
